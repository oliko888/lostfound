...
function showPost(e) {
    ...
    xmlhttp.open("GET", "/lostfound/ajax?auction=" + id, true);
    xmlhttp.send();
}
...
function editFoundPost(id) {
    ...
    xmlhttp.open("GET", "/lostfound/ajax?editFound=" + id, true);
    xmlhttp.send();
}

function deleteAuctionPost(id) {
    smallModalOpen();
    var xmlhttp = new XMLHttpRequest();
    xmlhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
    ...
    xmlhttp.open("GET", "/lostfound/ajax?deleteAuction=" + id, true);
    xmlhttp.send();
}
